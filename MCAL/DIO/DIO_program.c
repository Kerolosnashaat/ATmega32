...
u8 DIO_u8SetPinDirection( u8 Copy_u8Port, u8 Copy_u8Pin, u8 Copy_u8Direction){
	...
	if(Copy_u8Pin <= DIO_u8PIN7){
		if( Copy_u8Direction == DIO_u8PIN_OUTPUT ){
			switch(Copy_u8Port){
			case DIO_u8PORTA : SET_BIT(DA, Copy_u8Pin); break;
			case DIO_u8PORTB : SET_BIT(DB, Copy_u8Pin); break;
			case DIO_u8PORTC : SET_BIT(DC, Copy_u8Pin); break;
			case DIO_u8PORTD : SET_BIT(DD, Copy_u8Pin); break;
			default: Local_u8ErrorState = DIO_u8ERROR; break;
			}
		}else if ( Copy_u8Direction == DIO_u8PIN_INPUT ){
			switch(Copy_u8Port){
			case DIO_u8PORTA : CLR_BIT(DA, Copy_u8Pin); break;
			case DIO_u8PORTB : CLR_BIT(DB, Copy_u8Pin); break;
			case DIO_u8PORTC : CLR_BIT(DC, Copy_u8Pin); break;
			case DIO_u8PORTD : CLR_BIT(DD, Copy_u8Pin); break;
			default: Local_u8ErrorState = DIO_u8ERROR; break;
			}
...
u8 DIO_u8SetPortDirection( u8 Copy_u8Port, u8 Copy_u8Direction){
	u8 Local_u8ErrorState = DIO_u8NO_ERROR;
	switch(Copy_u8Port){
	case DIO_u8PORTA : DA = Copy_u8Direction; break;
	case DIO_u8PORTB : DB = Copy_u8Direction; break;
	case DIO_u8PORTC : DC = Copy_u8Direction; break;
	case DIO_u8PORTD : DD = Copy_u8Direction; break;
	default: Local_u8ErrorState = DIO_u8ERROR; break;
	}
	return Local_u8ErrorState;
}
